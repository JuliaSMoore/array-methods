...
const total = orders.map((num) => num = (Math.round(num.price * num.tax * 100) / 100) + num.price)
...
let bobArr = purchases.filter((name) => name.owner ===`Bob`)

const bobTotal = bobArr.reduce((acc, cur) => acc + cur.price, 0)
